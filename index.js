...
function is31Flavors(largeList){
   if (largeList.length === 31){
   return true;
   } 
   else {
   return false;
...
function addFlavor(arrayOne, flavor){
   arrayOne.unshift(flavor)
   return arrayOne;
}
...
function removeLastFlavor(arrayOne){
   arrayOne.pop()
   return arrayOne;
}
